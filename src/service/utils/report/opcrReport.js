...
export default function createOpcrPdf({
  ...
  var img = new Image();
  var completeName = "RAYMOND Q. ZARATAR";
  var positionRank = "ADMINISTRATIVE OFFICER V";
  var officeName = "Management Information System";
  ...
  doc.save(`${moment().format("MMMM Do YYYY, h:mm:ss a")} - ${officeName}.pdf`);
}
